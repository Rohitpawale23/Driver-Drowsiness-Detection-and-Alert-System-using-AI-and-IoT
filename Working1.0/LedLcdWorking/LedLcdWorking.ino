...
// Capture image and send as JPEG
void handleCapture() {
...
void handleLCD() {
  if (server.hasArg("text")) {
    ...
    lcd.print("Status:");
    lcd.setCursor(0, 1);
    lcd.print(text.substring(0, 16)); // Display only first 16 characters
...
void setup() {
  ...
  // Initialize LCD with correct cols and rows
  lcd.begin(16, 2);
  lcd.backlight();
  lcd.setCursor(0, 0);
  ...
  lcd.setCursor(0, 1);
  lcd.print("for Drivers");
  delay(1100);

  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("Discoverd by");
  lcd.setCursor(0, 1);
  ...
  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("1.Vaibhav Kangane");
  delay(900);

  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("2.Om Pardesi");
  delay(900);

  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("3.Rohit Pawale ");
  delay(900);
  ...
  // LCD update after boot
  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("System Ready to");
  lcd.setCursor(0, 1);
  // lcd.print(WiFi.localIP());
  lcd.print("detect Drowsiness...");
